...
\begin{figure} [H]
	\centering
	\begin{tabular}{*2c}
		\subfloat[Exterior Application]{\includegraphics[height = 3in ]{0_Images/Tactical_Considerations/Reach_of_Stream/ExteriorApplication.png}} &
		\subfloat[Interior Application]{\includegraphics[height = 3in]{0_Images/Tactical_Considerations/Reach_of_Stream/InteriorApplication.png}} \\
	\end{tabular}
...
\begin{figure} [H]
	\centering
	\begin{tabular}{*2c}
		\subfloat[Bedroom 2 Door Velocities]{\includegraphics[width = 3.25in ]{0_Images/Tactical_Considerations/Reach_of_Stream/Bed2Door_ExteriorAttack.pdf}} &
		\subfloat[Ventilation Configuration]{\includegraphics[width = 3.25in]{0_Images/Tactical_Considerations/Reach_of_Stream/ExteriorVentConfig.png}} \\
	\end{tabular}
\end{figure}
...
\begin{figure} [H]
	\centering
	\begin{tabular}{*3c}
		\subfloat[Bedroom Temperatures]{\includegraphics[width = 2 in ]{0_Images/Tactical_Considerations/Reach_of_Stream/TwoStoryBed4AttackTemps.pdf}} &
		\subfloat[Hallway Gas Concentrations]{\includegraphics[width = 2 in ]{0_Images/Tactical_Considerations/Reach_of_Stream/TwoStoryBed4AttackHallGas.pdf}} &
		\subfloat[Bedroom Temperatures]{\includegraphics[width = 2 in ]{0_Images/Tactical_Considerations/Reach_of_Stream/TwoStoryBed4Attack5Ft.pdf}} \\
	\end{tabular}
\end{figure}
