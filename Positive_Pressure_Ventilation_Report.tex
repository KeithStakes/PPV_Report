...
\begin{figure}[H]
	...
	\begin{tabular}{c c}
		...
		\subfloat[Two Story]{\includegraphics[width = 2.5.in]{0_Images/Tactical_Considerations/Ongoing_Assessment/TwoStoryFrontDoorVelocities.pdf}} \\
	\end{tabular}
